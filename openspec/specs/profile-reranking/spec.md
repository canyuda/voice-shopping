...
Profile-based reranking capability: combine cosine similarity with user profile signals (budget anchor, brand preference, price sensitivity, recent purchase dedup) via ProfileReranker to produce a final ranking.
