...
public class RecommendOrchestrator {
    ...
    public RecommendResult recommend(String sessionId,
        ...
        // 9. Take top K — reasons are now generated by the merged emotion prompt,
        //    so we return items with reason=null here.
        List<RecommendedItem> topK = reranked.stream()
                .limit(FINAL_TOP_K)
                .collect(Collectors.toList());

        // 10. Return result (reason generation deferred to EmotionAgent)
